...
using WebListening.ViewModels.Account;
        ...
        public async Task<JsonResult> Login([FromBody]LoginViewModel model /*, string returnUrl = null*/)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var role =
                        await _userManager.IsInRoleAsync(_userManager.Users.Where(x => x.Email.Equals(model.Email)).First(), "admin") ? "a" : "";
                ...
                if (result.IsLockedOut)
                {
                    ...
                    return Json(new[] { "User account locked out. Please contact administrator." });
                }
                else
                {
